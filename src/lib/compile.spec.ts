      ...
      return compile(root, { name: 'root', cwd: __dirname, ambient: false, meta: true, emitter })
        .then((result) => {
          t.equal(result.main, [
            ...
            '}',
            'declare module \'root/root.import\' {',
            'import alias = require(\'~root/root.import\');',
            'export = alias;',
            '}',
            '',
            `// Generated by typings`,
            ...
            '}',
            'declare module \'root/root\' {',
            'import alias = require(\'~root/root\');',
            'export = alias;',
            '}',
            'declare module \'root\' {',
            'import alias = require(\'~root/root\');',
      ...
      return compile(file, { name: 'foobar', cwd: __dirname, ambient: false, meta: false, emitter })
        .then(results => {
          t.equal(results.main, [
            ...
            '}',
            'declare module \'foobar/file\' {',
            'import alias = require(\'~foobar/file\');',
            'export = alias;',
            '}',
      ...
      return compile(file, { name: 'test', cwd: __dirname, ambient: false, meta: false, emitter })
        .then(results => {
          t.equal(results.main, [
            ...
            '}',
            'declare module \'test/index\' {',
            'import alias = require(\'~test/index\');',
            'export = alias;',
            '}',
            'declare module \'test\' {',
            'import alias = require(\'~test/index\');',
      ...
      return compile(root, { name: 'test', cwd: __dirname, ambient: false, meta: false, emitter })
        .then(results => {
          t.equal(results.main, [
            ...
            'import alias = require(\'~test~foo/index\');',
            'export = alias;',
            '}',
            '',
            'declare module \'~test/index\' {',
      ...
      return compile(file, { name: 'test', cwd: __dirname, ambient: false, meta: false, emitter })
        .then(results => {
          t.equal(results.main, [
            ...
            '}',
            'declare module \'test/import\' {',
            'import alias = require(\'~test/import\');',
            'export = alias;',
            '}',
            '',
            'declare module \'~test/index\' {',
    ...
    return resolveNpmDependencies({ cwd: FIXTURE_DIR, dev: false, emitter })
      ...
      .then(result => {
        t.equal(result.browser, [
          ...
          '}',
          'declare module \'main/override\' {',
          'import alias = require(\'~main/override\');',
          'export = alias;',
          '}',
          '',
          ...
          '}',
          'declare module \'main/index\' {',
          'import alias = require(\'~main/index\');',
          'export = alias;',
          '}',
          'declare module \'main\' {',
          'import alias = require(\'~main/index\');',
    ...
    return resolveNpmDependencies({ cwd: FIXTURE_DIR, dev: false, emitter })
      ...
      .then(result => {
        t.equal(result.main, [
          ...
          '}',
          'declare module \'main/imported\' {',
          'import alias = require(\'~main/imported\');',
          'export = alias;',
          '}',
          '',
          'declare module \'~main/index\' {',
        ...
        t.equal(result.browser, [
          ...
          'import alias = require(\'~main~dep/index\');',
          'export = alias;',
          '}',
          '',
          'declare module \'~main/index\' {',
    ...
    return compile(node, { name: 'test', cwd: __dirname, ambient: false, meta: false, emitter })
      .then(function (result) {
        t.equal(result.main, [
          ...
          '}',
          'declare module \'test/test\' {',
          'import alias = require(\'~test/test\');',
          'export = alias;',
          '}',
          '',
          'declare module \'~test/index\' {',
